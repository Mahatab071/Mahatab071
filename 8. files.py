...
with open('python/data/example.csv', 'w', newline='') as file:
...
with open('python/data/example.csv', 'r') as file:
...
with open('python/data/users.json', 'w') as file:
    json.dump(users, file)

with open('python/data/users.json', 'r') as file:
...
csv_file_path = "python/data/example.csv"  
json_file_path = "python/data/exj.json"  
