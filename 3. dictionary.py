...
student["grades"]["Physical Education"] = 89
print("\nAfter adding a new subject:")
print(student["grades"])

# Removing a subject
removed_grade = student["grades"].pop("History", None)
print("After removing 'History':")
print(student["grades"])


# Modifying an existing subject's grade
student["grades"]["Math"] = 98
print("After modifying 'Math' grade:")
print(student["grades"])

# Changing the student's name
student["name"] = "Alice Marie Johnson"
print("After modifying the name:")
...
# Write your code below:
# Dictionary of student names as keys and lists of grades as values
students = {
    "Alice": [85, 92, 88],
    "Bob": [78, 81, 74],
    "Charlie": [95, 98, 100],
