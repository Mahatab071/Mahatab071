...
# Write your code below:
age=50
residency='bangladeshi'

if age >=60 and  residency== 'bangladeshi':
    print('eligible')
else:
    print('not eligible')
...
if user_check==username and user_password ==password:
    print('login successful')
elif user_check!=username and user_password ==password:
...
def categorize_day(temperature, weather):
    ...
    if temperature >= 25 and weather == "sunny":
        ...
        return "Skiing Day"
    elif weather =="rainy" or temperature < 15 :
        return "Stay Home"
    else:
        return "Day doesn't fit any specific category."


temperature = float(input("Enter the temperature (°C): "))
weather = input("Enter  weather condition ")

result = categorize_day(temperature, weather)
print(f"Based on the conditions, it's a: {result}")
